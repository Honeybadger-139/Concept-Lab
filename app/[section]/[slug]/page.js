...
const ComponentMap = {
  ...
  ClusterAssignmentPlayground: withLoader(() => import("@/components/ClusterAssignmentPlayground")),
  KMeansIterationStudio:   withLoader(() => import("@/components/KMeansIterationStudio")),
  ElbowMethodExplorer:     withLoader(() => import("@/components/ElbowMethodExplorer")),
  GaussianDensityAnomalyViz: withLoader(() => import("@/components/GaussianDensityAnomalyViz")),
  AnomalyThresholdEvaluator: withLoader(() => import("@/components/AnomalyThresholdEvaluator")),
